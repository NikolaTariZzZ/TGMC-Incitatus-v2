### Это модульная папка проекта RU TGMC
...
📚 А также сокращённое пособие на Русском если вы уже знаете как работать с этим. **modularization_guide_ru_short.md**

☕ Данная модульная система взята с репозитория ныне закрытого проекта МассМета.
