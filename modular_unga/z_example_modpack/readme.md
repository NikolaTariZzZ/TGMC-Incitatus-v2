...
- Сами файлы кладутся в соотвествущие подпапки модульной папки `modular_unga/`.
...
- В таком случае дополнительно подпишите, что файл был полностью "перемещён". `Moved to modular_unga/z_example_modpack/my_file.dm`
...
Полное руководство по модульности находится в файле` modular_unga/modularization_guide_ru.md`
